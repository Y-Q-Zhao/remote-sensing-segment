# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 10:54:39 2019
...
checkpointer = ModelCheckpoint(modelpath+'unet.h5', verbose=1, save_best_only=True)
...
plt.savefig(resultpath+'unet_loss_mean_iou.jpg') 