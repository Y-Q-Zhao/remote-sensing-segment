...
modelpath = 'D:\\academic\\competition\\segment\\code\\semantic_segmentation\\model\\'  #####修改模型路径
...
checkpointer = ModelCheckpoint(modelpath + 'unet_2_1.h5', verbose=1, save_best_only=True)
