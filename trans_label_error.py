...
if __name__ == '__main__':
    # gray2rgb()
<<<<<<< HEAD
    filepath='E:\\test\\test_result5.png'
    lab_rgb=label2rgb( cv2.imread(filepath, cv2.IMREAD_GRAYSCALE))
    cv2.imwrite('E:\\test\\rgb5.png',lab_rgb)
=======
    label2rgb()
>>>>>>> 967b1c99b3a686d962f94cdc6faecfb38bd77974
